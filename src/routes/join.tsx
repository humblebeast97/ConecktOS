            ...
            {teamRoles.map((r) => {
              ...
              return (
                <button
                  ...
                  className={
                    selected
                      ? "flex min-h-[5rem] cursor-pointer flex-col items-center justify-center gap-2 rounded-2xl border-2 border-primary/70 bg-primary/10 px-2 py-3 text-center transition-all active:scale-[0.98]"
                      : "flex min-h-[5rem] cursor-pointer flex-col items-center justify-center gap-2 rounded-2xl border border-border bg-surface px-2 py-3 text-center transition-all hover:border-primary/40 active:scale-[0.98]"
                  }
                >
                  <span
                    className={
